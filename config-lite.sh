...
--enable-decoder=aac*,ac3*,ass,ssa,eac3,srt,flv,flac,h264*,hevc*,vc1*,mp1*,mp2*,mp3*,mpeg*,vorbis,vp6*,vp7*,vp8*,vp9*,wma*,wmv*,opus,pcm*,wmv*,rv* \
...
--disable-parsers --enable-parser=aac*,ac3,flac,h263,h264,hevc,mpeg*,opus,rv*,vc1,vorbis,vp8,vp9"
