...
--enable-decoder=aac*,ac3*,ass,ssa,eac3,srt,flv,flac,h264*,hevc*,vc1*,mp1*,mp2*,mp3*,mpeg*,vp6*,vp7*,vp8*,vp9*,wma*,wmv*,opus,pcm*,wmv*,rv* \
--disable-demuxers --enable-demuxer=aac,concat,data,flv,hls,h264,hevc,live_flv,matroska,mov,mpegts,mpegps,ac3,ass,avi,eac3,flac,flv,mp3,mpegvideo,mxf,nsv,nut,ogg,rawvideo,rtp,rtsp,srt,vc1,v210,wav --disable-bsfs --enable-bsf=aac*,h264*,hevc*,mpv*,mp3*,mpeg*,vp9* \
