...
--disable-encoders \
--disable-decoders \
--enable-decoder=*sub*,*text*,*web*,aac*,*ac3*,alac*,ape,ass,av1*,cc_dec,cook,dca,eac3*,truehd,ff*,*yuv*,flv,flac,gif,h26[3-4]*,hevc*,hap,mp[1-3]*,prores,*peg*,mlp,mpl2,nellymoser,opus,pcm*,*png*,rawvideo,rv*,sami,srt,ssa,v210*,vc1*,vorbis,vp[6-9]*,wm*,wrapped_avframe \
--disable-demuxers \
...
$USER_OPT
"
ENC_OPT="--enable-encoder=aac,ff*,*yuv*,gif,h26[3-4]*,hevc*,mjpeg,*png,mpeg[2-4]*,nellymoser,nvenc*,opus,pcm*,prores*,rawvideo,speedhq,vorbis,vp[7-9],wrapped_avframe"
