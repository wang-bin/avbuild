...
$USER_OPT
"
ENC_OPT="--enable-encoder=aac,gif,h26[3-4]*,hevc*,mjpeg,*png,mpeg[2-4]*,nellymoser,nvenc*,opus,pcm*,rawvideo,vorbis,vp*,wrapped_avframe"
MUX_OPT="--enable-muxer=dash,fifo,flv,gif,h264,hevc,hls,image2,mjpeg,matroska*,mov,mp4,mpegts,nu*,og*,pcm*,rawvideo,spdif,wav,webm,*pipe"
ENC_OPT_MOBILE="--enable-encoder=aac,gif,h264*,nellymoser,opus,pcm*,*jpeg,*png"
MUX_OPT_MOBILE="--enable-muxer=gif,hls,image2,mov,mp4,mpegts,wav"
